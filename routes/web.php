...
Route::middleware(['auth'])->group(function () {
    ...
    // 1. Dashboard (Course Registration)
    ...
    // 2. Academics (My Courses & Results)
...
Route::get('/setup', function () {
    // Admin
    User::firstOrCreate(['email' => 'admin@greenfield.com'], ['name' => 'System Admin', 'password' => bcrypt('admin123'), 'role' => 'admin']);

    // Student
    $student = User::firstOrCreate(['email' => 'student@greenfield.com'], ['name' => 'Test Student', 'password' => bcrypt('password123'), 'role' => 'student']);
    ...
    // Dummy Academics & Financials for the student
    Financial::firstOrCreate(['user_id' => $student->id, 'description' => 'Fall Semester Tuition'], ['amount' => 2500.00, 'type' => 'invoice']);
    Financial::firstOrCreate(['user_id' => $student->id, 'description' => 'Scholarship Credit'], ['amount' => 500.00, 'type' => 'payment']);
